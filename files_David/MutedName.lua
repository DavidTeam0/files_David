local function L9L9L_David(msg)
...
function L9L9L_name(t1,t2)
if t2.id_ then 
name_David = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_David then 
names_David = database:smembers(bot_id.."David:blocname"..msg.chat_id_) or ""
if names_David and names_David[1] then 
for i=1,#names_David do 
if name_David:match("(.*)("..names_David[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, L9L9L_name)
end
end
return {
David = L9L9L_David,
